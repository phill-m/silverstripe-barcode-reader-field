 ...
 * 
 */
var BarcodeReaderBaseSRC = 'barcode-reader-field/src/';
JOB = {
	Config : {
	...
	DecoderWorker : new Worker(BarcodeReaderBaseSRC + "DecoderWorker.js"),
	...
	Init : function() {
		...
		var script  = document.createElement('script');
  		script.src  = BarcodeReaderBaseSRC + "exif.js";
